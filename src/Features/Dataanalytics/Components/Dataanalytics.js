          ...
          return (
                    <div className="px-14">
                              <div className=" flex justify-between  py-4">
                                        <button type="button" class="text-gray-900  border border-gray-900 flex   rounded-lg text-sm px-5 py-2.5  " onClick={() => setShowModal(true)}>
                                        ...
                                        <button type="button" class="text-gray-900  border border-gray-900 flex font-mono rounded-lg text-sm px-5 py-2.5" onClick={() => setShowsetting(!showsettings)}>
