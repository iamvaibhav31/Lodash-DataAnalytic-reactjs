...
const Table = () => {
          ...
          const [filteredappdata, appdatadispatch] = useReducer(appdatareducer, appdata);
          ...
          const [filteredappname, appnamedispatch] = useReducer(appnamereducer, appname);
                                        ...
                                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                                  <tr>
                                                            {coloums.map((item) => {
                                                                      return (
                                                                                <>
                                                                                          {item.show && <th scope="col" class="py-3 px-6 relative">
                                                                                                    ...
                                                                                                    {(item.colname === "App Name" && namefilter) &&
                                                                                                              <div id="dropdownTop" class=" absolute top-12 z-10  bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                                                                                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" >
                                                                                                                                  <li className="p-2">
                                                                                                                                            <input type="text" className="text-gray-900  rounded-lg  p-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Search App Name" value={search}
                                                                                                                                  ...
                                                                                                                                  {filteredappname.map((item) => {
                                                                                                                                            return (<button className="w-full block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" onClick={() => {
                                                                                                                                  ...
                                                                                                                                  <li className="p-2 flex justify-end">
                                                                                                                                            ...
                                                                                                                                            <button className="p-2 border rounded-lg mx-2 font-mono border-blue-700 hover:bg-blue-700" onClick={() => {
                                                                                                                                                      appdatadispatch({
                                                                                                                                                                type: 'SearchByAppname',
                                                                                                                                                                Search: fname
                                                                                                                                                      })
                                                                                                    ...
                                                                                                    {(item.colname === "AD Request" && requestrangefilter) &&
                                                                                                              <div id="dropdownTop" class=" absolute top-12 z-10  bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                                                                                                        <ul class="p-2 text-sm text-gray-700 dark:text-gray-200" >
                                                                                                                                  ...
                                                                                                                                  <li className="p-2 flex justify-end">
                                                                                                                                            <button className="p-2   mx-2 font-mono text-red-700" >Reset</button>
                                                                                                                                            <button className="p-2 border rounded-lg mx-2 font-mono border-blue-700 hover:bg-blue-700">Apply</button>
                                                                                                                                  </li>
                                                                                                                        </ul>
                                                                                                              </div>
                                                                                                    }
